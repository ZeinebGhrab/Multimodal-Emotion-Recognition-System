...
def dispatch_tool(tool_name: str, tool_input: "dict | str") -> str:
    # Ollama peut retourner les arguments comme chaîne JSON — on normalise ici
    ...
    if tool_name == "analyze_image":
        result = tool_analyze_image(tool_input.get("image_path", ""))
    elif tool_name == "analyze_text":
        result = tool_analyze_text(tool_input.get("text", ""))
